...
//custom script
jQuery('input[name="truepixel[mts_header_style]"').on('change', function(){
    //alert(jQuery(this).val());
    var $layout = jQuery(this).val();
    switch ($layout) {
    case 'regular_header':
      jQuery(this).closest('tr').siblings('tr').slice(0,4).hide('fast');
      jQuery(this).closest('tr').siblings('tr').slice(0,2).show('fast');
      break;

    case 'logo_in_nav_header':
      jQuery(this).closest('tr').siblings('tr').slice(0,4).hide('fast');
      jQuery(this).closest('tr').siblings('tr').slice(2,4).show('fast');
      break;
